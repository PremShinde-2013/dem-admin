      ...
      return (
            <Router>
                  ...
                  <Routes>
                        ...
                        <Route
                              path="/create-user"
                              element={isAuthenticated ? <CreateUser /> : <Navigate to="/create-user" />}
                        />
                        <Route
                              path="/add-user"
                              element={isAuthenticated ? <AddUser /> : <Navigate to="/add-user" />}
                        />
                        <Route
                              path="/all-users"
                              element={isAuthenticated ? <DisplayUser /> : <Navigate to="/all-users" />}
                        />
                  </Routes>
            </Router>
      );
